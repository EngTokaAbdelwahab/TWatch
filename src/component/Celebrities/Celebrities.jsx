...
export default function Celebrities() {
    const[celebritiesapi,setCelebritiesApi]=useState([])
...
setCelebritiesApi(x.data.results)
}
...
useEffect(()=>{
  ...
  return <>
  <h1 className=' mt-5 mb-3 text-center '>Trend celebrities</h1>
  <div className="container">
    <div className="row">
    <div className="col-md-3 d-flex align-items-center">
      <div>
      <div className="border w-25 mb-3"></div>
      <h2 className=' h4'>Trending celebrities </h2>
      <div className=" w-100 mt-3 border "></div>
      </div>
    </div>

        
      {celebritiesapi.slice(0,10).map((item,index)=><div className="col-md-3" key={index}>
